...
@Mod(RespawnBlock.MODID)
public class RespawnBlock {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "respawnblock";
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS
            .register("example_tab", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.respawnblock")) // The language key for the title of your
                                                                             // CreativeModeTab
    ...
    public RespawnBlock(IEventBus modEventBus, ModContainer modContainer) {
